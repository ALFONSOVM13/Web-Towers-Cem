...
export const products = [
...

   {
      ...
      description: 'El cemento X tipo ART uso Estructural está elaborado con materias primas cuidadosamente seleccionadas, lo que garantiza unas altas resistencias mecánicas tanto iniciales como finales, proporcionando una alta manejabilidad y un rendimiento óptimo.',
