      ...
      <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
        <div>
          ...
          <input
            ...
            className="mt-1 sm:mt-2 block w-full rounded-md bg-gray-100 border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
            required
          />
        </div>
