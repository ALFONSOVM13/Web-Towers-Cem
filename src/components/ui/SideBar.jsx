        ...
        >
          ...
          <ul className="flex-1 mt-16 flex flex-col gap-1">
            <li>
              <Link
                href="/admin/noticias"
                className={`flex items-center gap-5 text-white px-4 py-2 rounded-md hover:bg-primary-200`}
              >
                <FaNewspaper size={20} className="text-lg text-white" />
                <span
            ...
            <li>
              <Link
                ...
                className={`flex items-center gap-5 text-white px-4 py-2 rounded-md hover:bg-primary-200`}
              >
                <FaCalendarCheck size={20} className="text-lg text-white" />
                <span
                  className={`min-w-[150px] transition-all duration-500 ${
                    toggleSideMenu
                      ? "opacity-100"
            ...
            <li>
              <Link
                ...
                className={`flex items-center gap-5 text-white px-4 py-2 rounded-md hover:bg-primary-200`}
              >
                <FaUserGroup size={20} className="text-lg text-white" />
                <span
                  className={`min-w-[150px] transition-all duration-500 ${
                    toggleSideMenu
                      ? "opacity-100"
          ...
          <div className="border-t border-t-slate-700 py-2">
            <button
              ...
              className="flex items-center w-full gap-5 text-white px-4 py-2 rounded-md hover:bg-primary-200 mb-2"
            >
...
//     <>
//       <div
//         className={`relative z-30 min-h-screen ${toggleSideMenu
//             ? "translate-x-0 sm:min-w-[240px]"
//             : " -translate-x-full sm:translate-x-0 sm:w-[60px]"
//           }`}
//       ></div>
...
//       <div
//         className={`fixed left-0 top-0 bottom-0 z-30 min-h-screen py-4 bg-slate-800 transition-all duration-500 ${toggleSideMenu
//             ? "w-[260px] translate-x-0 sm:w-[240px]"
//             : "w-[270px] -translate-x-full sm:translate-x-0 sm:w-[60px]"
//           } animate-fade`}
//       >
//         <nav
//           className={`fixed top-0 bottom-0 h-full group flex flex-col bg-slate-800 py-4 px-1 transition-all duration-500 overflow-hidden z-40 ${toggleSideMenu
//               ? "sm:w-[240px]"
//               : "w-[252px] sm:w-[60px] sm:hover:w-[240px]"
//             }`}
//         >
...
//               />
//               <span
//                 className={`min-w-[150px] transition-all duration-500 text-[1.1rem] font-light ${toggleSideMenu
//                     ? "opacity-100"
//                     : "sm:opacity-0 group-hover:opacity-100"
//                   }`}
//               >
...
//                 <span
//                   className={`min-w-[150px] transition-all duration-500 ${toggleSideMenu
//                       ? "opacity-100"
//                       : "sm:opacity-0 group-hover:opacity-100"
//                     }`}
//                 >
...
//               <CiLogout size={20} className="text-lg text-white" />
//               <span
//                 className={`text-left min-w-[150px] transition-all duration-500 ${toggleSideMenu
//                     ? "opacity-100"
//                     : "sm:opacity-0 group-hover:opacity-100"
//                   }`}
//               >
